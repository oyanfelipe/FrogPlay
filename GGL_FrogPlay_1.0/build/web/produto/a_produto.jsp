                        ...
                        <div class="card-body">
                            <div class="container-centered aling-center">
                                ...
                                <% try {
                                        ...
                                        out.println("'<div class='alert alert-success alert-dismissible' id='carregar' style='display:none;'><strong>Editado com Sucesso</strong> <BR>Para visualizar a alteração do produto <a href='gerenciar_produtos.jsp' class='alert-link'>clique aqui</a>.</div>'");
                                    } catch (Exception e) {
