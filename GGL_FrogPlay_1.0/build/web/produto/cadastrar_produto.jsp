...
<body>
    ...
    <div class="container p-3 my-3 border border-success bg-dark">
        <div class="card bg-dark">
            <h1 class="text-success text-center">Cadastrar Produto</h1>
        </div>
        <div class="row">
            <div class="container align-self-center d-flex justify-content-center">
                <form action="c_produto.jsp" method="POST">

                    <label class="text-light">ID Produto:</label><Br>
                    <input type="text" id="disabledInput" disabled="" value=""><Br><Br>

                    <label class="text-light">Nome do Produto:</label><Br>
                    <input type="text" id="disabledInput" name="nome_produto"><Br><Br>

                    <label class="text-light">Nome da Produtora/Editora:</label><Br>
                    <input type="text" id="disabledInput" name="produtora"><Br><Br>

                    <label class="text-light">Quantidade no Estoque:</label><Br>
                    <input type="number" id="disabledInput" name="quantidade_estoque"><Br><Br>

                    <label class="text-light">Preço do Produto:</label><Br>
                    <label class="text-light">R$</label>
                    <input type="text" id="disabledInput" name="preco" size="17"><Br><Br>
