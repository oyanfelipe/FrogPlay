        ...
        <div class="container p-3 my-3 border border-success bg-dark">
            ...
            <div class="row">
                <div class="container align-self-center d-flex justify-content-center">
                    <form action="a_funcionario.jsp" method="POST">

                        <label class="text-light" >ID Funcionário: <%=request.getParameter("id")%> </label><Br>
                        <input type="text" id="disabledInput" hidden="" name="id" value="<%=request.getParameter("id")%>"><Br>

                        <label class="text-light">Usuario</label><Br>
                        <input type="text" id="disabledInput" name="usuario" value="<%=request.getParameter("usuario")%>" ><Br>

                        <label class="text-light">Senha</label><Br>
                        <input type="password" id="disabledInput" name="senha" value="<%=request.getParameter("senha")%>"><Br>
                        
                        <label class="text-light">Salario</label><Br>
                        <input type="text" id="disabledInput" name="salario" value="<%=request.getParameter("salario")%>"><Br>

                        <label class="text-light">Cargo</label><Br>
                        <input type="text" id="disabledInput" name="cargo" value="<%=request.getParameter("cargo")%>"><Br>

                        <label class="text-light">Nome Completo</label><Br>
                        <input type="text" id="disabledInput" name="nome_completo" value="<%=request.getParameter("nome_completo")%>"><Br>

                        <label class="text-light">E-mail</label><Br>
                        <input type="text" id="disabledInput" name="email" value="<%=request.getParameter("email")%>" ><Br>

                        <label class="text-light">Telefone</label><Br>
                        <input type="text" id="disabledInput" name="telefone" value="<%=request.getParameter("telefone")%>"><Br>
                        <Br><Br>
