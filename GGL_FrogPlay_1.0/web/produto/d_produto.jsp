                        ...
                        <div class="card-body">
                            <div class="container-centered aling-center">
                                ...
                                <% try {
                                        ...
                                        out.println("'<div class='alert alert-success alert-dismissible' id='carregar' style='display:none;'><strong>Apagado com Sucesso</strong> <BR>Para visualizar os produtos ainda cadastrados <a href='gerenciar_produtos.jsp' class='alert-link'>clique aqui</a>.</div>'");
                                    } catch (Exception e) {
