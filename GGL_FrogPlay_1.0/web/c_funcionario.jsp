                        ...
                        <div class="card-body">
                          <div class="container-centered aling-center">
                            ...
                            <% try { FuncionarioDTO objFuncionarioDTO=new FuncionarioDTO();
                              ...
                              objFuncionarioDTO.setTelefone(request.getParameter("telefone")); FuncionarioDAO
                              objFuncionarioDAO=new FuncionarioDAO();
                              objFuncionarioDAO.CadastrarFuncionario(objFuncionarioDTO); 
                              out.println("'<div class='alert alert-success alert-dismissible' id='carregar' style='display:none;'><strong>Salvo com Sucesso</strong> <BR>Para visualizar o cadastro <a href='gerenciar_funcionarios.jsp' class='alert-link'>clique aqui</a>.</div>'");
                          } catch (Exception e) {
                          out.println(e);
                          }
                          %>
